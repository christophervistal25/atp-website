<td class="border-b w-5">
    <div class="flex sm:justify-center items-center ">
        ...
        @if(!$person->account->status)
            <a class="flex items-center bg-white mr-3 rounded-full p-3 shadow" href="{{ route('municipal.print.qr', $person->id) }}" title="View generated I.D">
            ...
            <a class="flex items-center bg-white rounded-full p-3 shadow" href="{{ route('modification.request', $person->id) }}" title="View generated I.D">
