                    ...
                    <div class="intro-y col-span-12 lg:col-span-6">
                        ...
                        <div class="intro-y box">
                            ...
                            <div class="p-5" id="input">
                                <form method="POST" enctype="multipart/form-data" action="{{ route('administrator.store') }}" class="preview">
                                    @csrf
                                        ...
                                        <div class="flex-1 flex flex-col md:flex-row">
                                            ...
                                            <div class="w-full flex-1 mx-2">
                                                ...
                                                <div class="p-1 bg-white flex border rounded">
                                                    <input placeholder="e.g Jr" class="p-1 px-2 appearance-none outline-none w-full text-gray-800" type="text" maxlength="3" placeholder="e.g. Jr" name="suffix" value="{{  old('suffix') }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex lg:justify-end mt-5">
                                        <button type="submit" class="button bg-theme-1 text-white w-auto">Add New Administrator</button>    
                                    </div>
                                </form>
                             </div>
                            </div>
