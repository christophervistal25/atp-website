                    ...
                    <div class="intro-y col-span-12 lg:col-span-6">
                                ...
                                <div class="box">
                                    <div class="flex flex-col lg:flex-row items-center p-5 bg-theme-9 rounded mb-2">
                                        <div class="lg:ml-2 lg:mr-auto text-center lg:text-left mt-3 lg:mt-0">
                                            <p class="font-medium text-white">{{  $establishment->name }} Establishment Update Successfully!</p> 
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="intro-y box">
                            ...
                            <div class="p-5" id="input">
                                <form method="POST" action="{{ route('establishment.update', $establishment->id) }}" class="preview">
                                    @csrf
                                    @method('PUT')
                                    <div class="flex flex-col md:flex-row border-b border-gray-200 pb-4 mb-4">
                                        <div class="flex-1 flex flex-col md:flex-row">
                                            <div class="w-full flex-1">
                                                ...
                                                <div class="p-1 bg-white flex border rounded  {{ $errors->has('name')  ? 'border-red-500' : '' }}">
                                                    <input class="p-1 px-2 appearance-none outline-none w-full text-gray-800" type="text" placeholder="e.g. Gaisano Capital" aria-invalid="true" name="name" value="{{  old('name') ?? $establishment->name }} ">
                                                </div>
                                    ...
                                    <div> 
                                        ...
                                        <textarea  class="input w-full border {{  $errors->has('address')  ? 'border-theme-6' : '' }}" name="address" rows="5">{{ old('address') ?? $establishment->address }}</textarea>
                                        <div class="text-xs text-theme-6">
                                    ...
                                    <div class="mt-3 mb-3"> 
                                        ...
                                        <input type="text" class="input w-full border {{  $errors->has('contact_no')  ? 'border-theme-6' : '' }}" placeholder="+639193693499" value="{{  old('contact_no') ?? $establishment->contact_no }}" name="contact_no">
                                        <div class="text-xs text-theme-6">
                                    ...
                                    <div class="mt-3"> 
                                        ...
                                        <input type="text" class="input w-full border {{  $errors->has('geo_tag_location')  ? 'border-theme-6' : '' }}" value="{{ $establishment->latitude }}&{{ $establishment->longitude }}" name="geo_tag_location" id="geo_tag_location" readonly>
                                        <div class="text-xs text-theme-6">
                                        ...
                                        <div class="flex-1 flex flex-col md:flex-row">
                                            <div class="w-full flex-1 mr-2">
                                                ...
                                                <span class="sm:ml-auto mt-1 sm:mt-0 text-xs text-red-600">*</span>
                                                    <select class="select2 w-full input border {{ $errors->has('city')  ? 'border-theme-6' : ''}}" name="city" id="cities">
                                                        ...
                                                        <option selected value="{{  $establishment->city_code }}">{{  $establishment->city->name }}</option>
                                                    </select> 
                                                <div class="text-xs text-theme-6">
                                                    @if($errors->has('city'))
                                                        {{ $errors->first('city') }}
                                            ...
                                            <div class="w-full flex-1">
                                                ...
                                                <select name="barangay" id="barangay" class="select2 w-full input border {{ $errors->has('barangay')  ? 'border-theme-6' : ''}}">
                                                    ...
                                                    <option selected value="{{  $establishment->barangay_code }}">{{  $establishment->barangay->name }}</option>
                                                </select>
                                                <div class="text-xs text-theme-6">
                                    ...
                                    <div class="flex lg:justify-end mt-5">
                                        <button type="submit" class="button bg-theme-9 shadow text-white w-auto">Edit Establishment</button>    
                                    </div>
                                </form>
                             </div>
                            </div>
