                    ...
                    <div class="intro-y col-span-12 lg:col-span-6">
                        ...
                        <div class="intro-y box">
                            ...
                            <div class="p-5" id="input">
                                <form method="POST" enctype="multipart/form-data" action="{{ route('personnel.store') }}" class="preview">
                                    @csrf
                                        ...
                                        <div class="flex-1 flex flex-col md:flex-row">
                                            <div class="w-full flex-1 mx-2">
                                                ...
                                                <div class="p-1 bg-white flex border rounded  {{ $errors->has('firstname')  ? 'border-red-500' : '' }}">
                                                    <input class="p-1 px-2 appearance-none outline-none w-full text-gray-800" type="text" placeholder="e.g. Christopher" aria-invalid="true" name="firstname">
                                                </div>
                                                <span class="sm:ml-auto mt-1 sm:mt-0 text-xs text-red-600">Required, at least 3 characters</span>
                                            </div>
                                            <div class="w-full flex-1 mx-2">
                                                Middlename
                                                <span class="sm:ml-auto mt-1 sm:mt-0 text-xs text-red-600">*</span>
                                                <div class="p-1 bg-white flex border {{ $errors->has('middlename')  ? 'border-red-500' : '' }} rounded">
                                                    <input class="p-1 px-2 appearance-none outline-none w-full text-gray-800" type="text" placeholder="e.g. Platino" name="middlename">
                                                </div>
                                                <span class="sm:ml-auto mt-1 sm:mt-0 text-xs text-red-600">Required, at least 2 characters</span>
                                            </div>
                                            ...
                                            <div class="w-full flex-1 mx-2">
                                                ...
                                                <div class="p-1 bg-white flex border {{ $errors->has('lastname')  ? 'border-red-500' : '' }} rounded">
                                                    <input class="p-1 px-2 appearance-none outline-none w-full text-gray-800" type="text" placeholder="e.g. Vistal" name="lastname">
                                                </div>
                                                <span class="sm:ml-auto mt-1 sm:mt-0 text-xs text-red-600">Required, at least 2 characters</span>
                                            </div>
                                            ...
                                            <div class="w-full flex-1 mx-2">
                                                ...
                                                <div class="p-1 bg-white flex border rounded">
                                                    <input placeholder="Enter Suffix" class="p-1 px-2 appearance-none outline-none w-full text-gray-800" type="text" maxlength="3" placeholder="e.g. Jr" name="suffix">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="w-full flex-1 mx-2">
                                        ...
                                        <div class=" p-1 bg-white flex border {{ $errors->has('date_of_birth')  ? 'border-red-500' : 'border' }} rounded">
                                            <input name="date_of_birth" placeholder="Date of Birth" class="p-1 px-2 appearance-none outline-none w-full text-gray-800" type="date">
                                        </div>
                                    </div>
                                    <div class="mb-2"></div>
                                    ...
                                    <div class="mb-2 flex-1 flex flex-col md:flex-row">
                                        ...
                                        <div class="w-full flex-1 mx-2">
                                            ...
                                            <div class="p-1 bg-white flex ">
                                                <input class="input border p-2 px-2 appearance-none outline-none w-full text-gray-800 border {{  $errors->has('phone_number') ? 'border-red-500' : '' }}" type="text" placeholder="e.g.+639193693499" name="phone_number">
                                            </div>
                                    ...
                                    <div class="flex lg:justify-end">
                                        <button type="submit" class="button bg-theme-1 text-white w-auto">Add New Personnel</button>    
                                        @if(Session::has('success'))
                                            <button type="submit" class="ml-2 button bg-green-500 text-white btn--md">View Generated QR</button>
                                        @endif
                                    </div>
