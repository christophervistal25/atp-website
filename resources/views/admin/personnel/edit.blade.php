                        ...
                        <div class="intro-y box">
                            ...
                            <div class="p-5" id="input">
                                <form method="POST" enctype="multipart/form-data"
                                    action="{{ route('personnel.update', $personnel->id) }}" class="preview">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="flex lg:justify-end">
                                        <button type="submit" class="button bg-theme-9 shadow text-white w-auto">Update
                                            <span class="capitalize">{{ strtolower($personnel->firstname) }}</span>'s
                                            Information</button>
                                        @if(Session::has('success'))
                                        <a href="{{ route('admin.print.qr', Session::get('success')) }}"
                                            class="ml-2 button bg-green-500 text-white btn--md">View Generated QR</a>
                                        @endif
                                    </div>
