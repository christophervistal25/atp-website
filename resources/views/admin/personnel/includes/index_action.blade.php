<td class="border-b w-5">
    <div class="flex sm:justify-center items-center ">
        <a class="flex items-center mr-3 rounded-full p-3 bg-white shadow" href="{{ route('personnel.logs', $person->id) }}" title="View Profile"> 
        ...
        <a class="flex items-center bg-white rounded-full p-3 mr-3 shadow" href="{{ route('personnel.edit', $person->id) }}" title="Edit Personnel"> 
        ...
        @if(!$person->account->status)
            <a class="flex items-center bg-white rounded-full p-3 shadow" href="{{ route('admin.print.qr', $person->id) }}" title="View generated I.D"> 
