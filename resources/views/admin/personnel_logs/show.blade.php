    ...
    <div class="intro-y box px-5 pt-5 mt-5">
        <div class="flex flex-col lg:flex-row border-b border-gray-200 pb-5 -mx-5">
            <div class="flex flex-1 px-5 items-center justify-center lg:justify-start">
                ...
                <div class="ml-5">
                    <div class="w-auto truncate sm:whitespace-normal font-medium text-md">{{  $person->firstname }} {{  $person->middlename }} {{  $person->lastname }} {{  $person->suffix }}</div>
            ...
            <div class="flex mt-6 lg:mt-0 items-center lg:items-start flex-1 flex-col justify-center text-gray-600 px-5 border-l border-r border-gray-200 border-t lg:border-t-0 pt-5 lg:pt-0">
                ...
                <div class="truncate sm:whitespace-normal flex items-center"> 
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" class="mr-2 mb-2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-phone mx-auto"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>
                    <span class="text-md">{{  $person->landline_number ?? 'No Landline Number' }}</span> 
                </div>
                <div class="truncate sm:whitespace-normal flex items-center"> 
                    <a target="_blank" href="{{ route('admin.print.qr', $person->id) }}"
                    class="button button--sm text-white bg-theme-1 mr-2">View Personnel I.D</a>
                </div>
            </div>
        </div>
    ...
    <div class="intro-y tab-content mt-5">
        <div class="tab-content__pane active" id="dashboard">
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="intro-y box col-span-12 lg:col-span-6">
                    <div class="flex items-center p-5 border-b border-gray-200">
                        ...
                        <div class="dropdown relative ml-auto">
                            <a class="w-5 h-5 px-2 py-2 text-gray-900 rounded bg-theme-8 font-medium" href="{{  route('personnel.edit', $person->id) }}"> 
                                EDIT
                            </a>
                ...
                <!-- BEGIN: Latest Tasks -->
                <div class="box col-span-12 lg:col-span-12 {{  request()->has('from_track') ? 'border border-theme-15 shadow intro-x ' : 'intro-y' }}">
                    <div class="flex items-center px-5 py-5 sm:py-0 border-b border-gray-200">
                        <h2 class="font-medium text-base mr-auto py-5" >
                            Personnel History
                        </h2>
