                ...
                <ul>
                    ...
                    <li>
                        <a href="javascript:;" class="side-menu">
                            ...
                            <div class="side-menu__title"> Province <i data-feather="chevron-down" class="side-menu__sub-icon"></i> </div>
                        </a>
                        <ul class="">
                            <li>
           ...
           <div class="dropdown-box mt-10 absolute w-56 top-0 right-0 z-20">
               <div class="dropdown-box__content box bg-theme-38 text-white">
                   <div class="p-4 border-b border-theme-40">
                       <div class="font-medium capitalize">{{  Auth::user()->lastname }}, {{  Auth::user()->firstname }} </div>
                       <div class="text-xs text-theme-41">{{ '@' . Auth::user()->username }} - Administrator</div>
                   </div>
                   <div class="p-2">
                       <a href="{{  route('admin.profile.edit') }}" class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 rounded-md"> <i data-feather="user" class="w-4 h-4 mr-2"></i> Update Profile </a>
                       <a href="{{  route('administrator.create') }}" class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 rounded-md"> <i data-feather="edit" class="w-4 h-4 mr-2"></i> Add Account </a>
