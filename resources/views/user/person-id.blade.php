...
@section('content')
 ...
 <div class="flex h-screen base">
  <div class="m-auto">
        ...
        <img id="person_image" class="w-40 h-40 mx-auto mt-5 image-fit mx-auto rounded border-4 border-color border-white border-2 shadow p-2 bg-white" src="{{ asset('/storage/images/' . $person->image) }}">
