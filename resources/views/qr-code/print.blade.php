...
<body>
    <div class="flex base" id="base-image">
        <div class="m-auto">
            ...
            <img id="person_image" class="w-24 h-24 mt-3 object-cover mx-auto rounded border-4 border-color border-white border-2 shadow p-1 mt-1 bg-white" src="{{ asset('/storage/images/' . $person->image) }}">
